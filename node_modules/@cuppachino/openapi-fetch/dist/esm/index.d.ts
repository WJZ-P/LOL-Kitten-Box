...
export type _OptionalTypedFetch<OP> = (arg?: OpArgType<OP>, init?: RequestInit) => Promise<ApiResponse<OpReturnType<OP>>>;
export type TypedFetch<OP> = _TypedFetch<OP> & {
    Error: new (error: ApiError) => ApiError & {
        getActualType: () => OpErrorType<OP>;
    };
};
export type TypedFetchOptional<OP> = OpArgType<OP> extends Record<PropertyKey, never> ? _OptionalTypedFetch<OP> & {
    Error: new (error: ApiError) => ApiError & {
        getActualType: () => OpErrorType<OP>;
    };
} : _TypedFetch<OP> & {
